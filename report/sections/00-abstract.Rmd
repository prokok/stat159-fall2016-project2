...
In this project, we will be testing alternate fit models to a data set aspiring to gernerate a response variable by many predictor variables that would not be feasable by regular least squares fitting.  
